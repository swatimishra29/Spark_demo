...
-- DROP TABLE hdm.cal_day_acct_position_history;

CREATE TABLE hdm.cal_day_acct_position_history (
	cal_day timestamp NOT NULL,
	acct_nbr numeric(38,15) NOT NULL,
	fund_nbr numeric(38,15) NOT NULL,
	share_count numeric(38,15) NULL,
	nav numeric(38,15) NULL,
	balance_amt numeric(38,15) NULL,
...
CREATE TABLE hdm.fi_issuer (
	fi_issr_key int4 NOT NULL,
	issr_nm varchar(255) NULL,
	curr_row_flg varchar(1) NULL,
	row_strt_dttm timestamp NULL,
	row_stop_dttm timestamp NULL,
	row_updt_dttm timestamp NULL,
...
-- DROP TABLE hdm.fund_trans_hist_debug;
...
CREATE INDEX fund_trans_hist_debug_ix_ie1 ON hdm.fund_trans_hist_debug USING btree (acct_nbr);
CREATE INDEX fund_trans_hist_debug_ix_ie2 ON hdm.fund_trans_hist_debug USING btree (shrhldr_key);
CREATE INDEX fund_trans_hist_debug_ix_ie3 ON hdm.fund_trans_hist_debug USING btree (row_strt_dttm);
CREATE INDEX fund_trans_hist_debug_ix_if1 ON hdm.fund_trans_hist_debug USING btree (dlr_key);
CREATE INDEX fund_trans_hist_debug_ix_if10 ON hdm.fund_trans_hist_debug USING btree (rsn_key);
CREATE INDEX fund_trans_hist_debug_ix_if11 ON hdm.fund_trans_hist_debug USING btree (ssn_stat_key);
CREATE INDEX fund_trans_hist_debug_ix_if12 ON hdm.fund_trans_hist_debug USING btree (sttl_day_key);
CREATE INDEX fund_trans_hist_debug_ix_if13 ON hdm.fund_trans_hist_debug USING btree (pmt_day_key);
CREATE INDEX fund_trans_hist_debug_ix_if14 ON hdm.fund_trans_hist_debug USING btree (trde_entry_mthd_key);
CREATE INDEX fund_trans_hist_debug_ix_if15 ON hdm.fund_trans_hist_debug USING btree (dlr_lvl_cntl_key);
CREATE INDEX fund_trans_hist_debug_ix_if16 ON hdm.fund_trans_hist_debug USING btree (pmt_mthd_key);
CREATE INDEX fund_trans_hist_debug_ix_if17 ON hdm.fund_trans_hist_debug USING btree (batch_day_key);
CREATE INDEX fund_trans_hist_debug_ix_if18 ON hdm.fund_trans_hist_debug USING btree (frto_fund_key);
CREATE INDEX fund_trans_hist_debug_ix_if19 ON hdm.fund_trans_hist_debug USING btree (spr_sheet_day_key);
CREATE INDEX fund_trans_hist_debug_ix_if3 ON hdm.fund_trans_hist_debug USING btree (acct_key);
CREATE INDEX fund_trans_hist_debug_ix_if4 ON hdm.fund_trans_hist_debug USING btree (fund_key);
CREATE INDEX fund_trans_hist_debug_ix_if5 ON hdm.fund_trans_hist_debug USING btree (efftv_day_key);
CREATE INDEX fund_trans_hist_debug_ix_if6 ON hdm.fund_trans_hist_debug USING btree (reg_key);
CREATE INDEX fund_trans_hist_debug_ix_if7 ON hdm.fund_trans_hist_debug USING btree (txn_type_key);
CREATE INDEX fund_trans_hist_debug_ix_if8 ON hdm.fund_trans_hist_debug USING btree (dlr_branch_key);
CREATE INDEX fund_trans_hist_debug_ix_if9 ON hdm.fund_trans_hist_debug USING btree (trde_orig_key);
...
CREATE INDEX tgtx_return_ix_if1 ON hdm.tgtx_return USING btree (fund_key);
CREATE INDEX tgtx_return_ix_if2 ON hdm.tgtx_return USING btree (trgt_perf_type_key);
CREATE INDEX tgtx_return_ix_if3 ON hdm.tgtx_return USING btree (day_key);
CREATE INDEX tgtx_return_ix_if4 ON hdm.tgtx_return USING btree (per_key);
CREATE INDEX tgtx_return_ix_if6 ON hdm.tgtx_return USING btree (bmk_idx_key);

-- Drop table

-- DROP TABLE hdm.tgtx_wealth_index;
...
CREATE INDEX tgtx_wealth_index_hcf1 ON hdm.tgtx_wealth_index USING btree (fund_key, trgt_perf_type_key, day_key, wlth_idx);
CREATE INDEX tgtx_wealth_index_ix_if1 ON hdm.tgtx_wealth_index USING btree (trgt_perf_type_key);
CREATE INDEX tgtx_wealth_index_ix_if2 ON hdm.tgtx_wealth_index USING btree (day_key);
CREATE INDEX tgtx_wealth_index_ix_if3 ON hdm.tgtx_wealth_index USING btree (fund_key);

-- Drop table

-- DROP TABLE hdm.tgtx_weights;
...
CREATE INDEX tgtx_weights_ix_if1 ON hdm.tgtx_weights USING btree (trgt_fund_key);
CREATE INDEX tgtx_weights_ix_if2 ON hdm.tgtx_weights USING btree (fund_key);
